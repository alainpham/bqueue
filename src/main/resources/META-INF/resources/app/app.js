...
function functionalProcessing(jsonMsg){
    ...
    switch (type) {
        ...
        case "distributed-frame-render-broadcast":
            ...
            delete jsonMsg.data[0].fileFormat;
            delete jsonMsg.data[0].colorDepth;
            delete jsonMsg.data[0].colorMode;
            delete jsonMsg.data[0].useComposition;
            delete jsonMsg.data[0].useAdaptiveSampling;
            delete jsonMsg.data[0].useDenoising;
